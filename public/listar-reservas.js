...
reservas.forEach(reserva => {
    registros += `
        <tr>
            ...
            <td>${reserva.nomobrePelicula}</td>
            <td>${reserva.fechaIngreso}</td>
            <td>${reserva.fechaSalida}</td>
            <td>${reserva.sala}</td>
            <td>${reserva.haciento}</td>
            <td>${reserva.precio}</td>

           <div class="row">
           <a href="/actualizar-reserva/${reserva.id}" class="btn btn-sm btn-info">Editar</a>
           <button class="btn btn-dark btn-sm" data-id="${reserva.id}" onClick=eliminarReserva(event)>Eliminar</button>
           </div>
            </td>
        </tr>
    `
